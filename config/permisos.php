...
return [
    ...
    'user_table' => function() {
        return (new \App\Models\User)->getTable(); // Obtener el nombre de la tabla dinámicamente
    },

    // Obtener dinámicamente la clave primaria del modelo de usuario
    'user_primary_key' => function() {
        return (new \App\Models\User)->getKeyName(); // Obtener la clave primaria dinámicamente
    },
